...
sev1_logrotate_app 'tomcat-myapp-multi-path' do
...
sev1_logrotate_app 'tomcat-myapp-no-enable' do
...
sev1_logrotate_app 'tomcat-myapp-custom-options' do
...
sev1_logrotate_app 'tomcat-myapp-custom-options-as-string' do
...
sev1_logrotate_app 'tomcat-myapp-custom-template' do
...
sev1_logrotate_app 'tomcat-myapp-sharedscripts' do
...
sev1_logrotate_app 'tomcat-myapp-multi-script' do
